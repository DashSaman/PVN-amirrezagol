...
9. **`research/AI_RESEARCH_CAMPAIGN.md`**
10. **`research/RESEARCH_COMPLETENESS.md`**
11. **`research/PROTOCOL_RESEARCH_TEMPLATE.md`**
12. **`research/SOURCE_MIRROR_POLICY.md`**
13. the relevant numbered folder under `research/protocols/`
14. relevant shared dossiers under `research/upstreams/`

Then inspect current Git history/repository state and continue from the documented incomplete work. Do not restart the research from zero because chat context was lost.
...
Anything required for another AI/developer to continue must be written into this repository. After meaningful research, update the relevant dossier, `research/RESEARCH_COMPLETENESS.md`, `docs/RESEARCH_LOG.md`, and `docs/PROJECT_STATE.md`.
...
First report that the mandatory files were read, state the current research status from `PROJECT_STATE.md` and `RESEARCH_COMPLETENESS.md`, then continue actual work from the next evidence gap. Do not merely propose a new plan and stop.
